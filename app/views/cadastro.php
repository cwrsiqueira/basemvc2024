    ...
    <div class="auth-box">
        ...
        <form method="post" class="auth-form" action="<?= URL ?>login/cadastrar">
            <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-lg <?php @$_SESSION['alert']['campo'] == 'username' ? 'border-danger' : ''; ?>" id="username" name="username" value="<?= @$_SESSION['alert']['old']['username'] ?? 'Carlos'; ?>" placeholder="Digite seu nome de usuário">
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control form-control-lg <?php @$_SESSION['alert']['campo'] == 'email' ? 'border-danger' : ''; ?>" id="email" name="email" value="<?= @$_SESSION['alert']['old']['email'] ?? 'cwrsiqueira@msn.com'; ?>" placeholder="Digite seu email">
            </div>
